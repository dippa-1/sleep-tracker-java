...
public class _ChartPanel extends JPanel implements NewEntryListener {
    private TimeSeries[] timeSeries;
    private _TimeSeriesPanel timeSeriesPanel;

    public _ChartPanel(ArrayList<SleepEntry> entries) {
        ...
        this.timeSeriesPanel = new _TimeSeriesPanel(this.timeSeries);
